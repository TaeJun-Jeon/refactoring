		...
		<div class="row">
			<form role="form" class="contact-form">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="form-group">
							제목 <input type="text" class="form-control" name="subject" autocomplete="off" id="subject" placeholder="홈페이지가 정말 좋네요!!">
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							내용
							<textarea class="form-control textarea" rows="3" name="content" id="content" placeholder="친절하고 진짜진짜 만족합니다"></textarea>
						</div>
					</div>
				</div>
			</form>
