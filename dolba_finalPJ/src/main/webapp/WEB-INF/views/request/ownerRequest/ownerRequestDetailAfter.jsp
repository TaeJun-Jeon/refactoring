				...
				<div class="panel panel-info">
								...
								<c:choose>
									<c:when test="${ownerRequestDTO.requestPaymentState eq 'y'}">
										...
										<sec:authorize access="hasAuthority('SITTER')">
											<a href="${pageContext.request.contextPath}/sitter/diaryForm?sittingId=${ownerRequestDTO.ownerRequestId}" class="btn btn-primary">일지작성</a>
										</sec:authorize>
										<sec:authorize access="hasAuthority('OWNER')">
											<a href="${pageContext.request.contextPath}/owner/requestDiaryList?sittingId=${ownerRequestDTO.ownerRequestId}" class="btn btn-primary">일지보기</a>
										</sec:authorize>
									</c:when>
									<c:otherwise>
										<sec:authorize access="hasAuthority('OWNER')">
					...
					<div class="panel-footer">
						<a data-original-title="Broadcast Message" data-toggle="tooltip" type="button" class="btn btn-sm btn-primary">
							<i class="glyphicon glyphicon-envelope"></i>결제
						</a>
						<span class="pull-right"> <a href="edit.html" data-original-title="Edit this user" data-toggle="tooltip" type="button"
								class="btn btn-sm btn-warning"
							>
								<i class="glyphicon glyphicon-edit"></i>
							</a> <a data-original-title="Remove this user" data-toggle="tooltip" type="button" class="btn btn-sm btn-danger">
