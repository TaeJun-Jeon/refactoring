...
insert into authorities values('jun','OWNER','1234','준준');
select * from pet;
select * from options;
select * from REPLY
...
select sitter_fname
		...
		insert into call values('call_id-'||sequence_CALL.NEXTVAL,'happymom','goodsitter',20000,'힘들어요','18-06-20','18-06-21',sysdate,1,null)
		select * from DIARY
		select * from OWNER_REQUEST
